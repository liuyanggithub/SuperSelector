...
//            return (position == 0) ? null : mList.get(position - 1);
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(mContext).inflate(R.layout.video_choose_griditem, container, false);
...
//                holder.imageView.setImageResource(R.mipmap.video_actionbar_camera_icon);
//            } else {
